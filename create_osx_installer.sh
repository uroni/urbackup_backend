...
./configure --with-crypto-prefix=$PWD/../cryptopp562 --enable-clientupdate CXXFLAGS="-mmacosx-version-min=10.6 -DNDEBUG" CFLAGS="-DNDEBUG" LDFLAGS="-mmacosx-version-min=10.6" --prefix="/Applications/UrBackup Client.app/Contents/MacOS"
make clean
make -j5
