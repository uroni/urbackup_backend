...
LocalFileBackup::LocalFileBackup(IBackupFileSystem* backup_files, int64 local_process_id, 
	...
	: LocalBackup(backup_files, local_process_id, server_log_id,
		server_status_id, backupid, std::move(server_token), std::move(server_identity),
		facet_id, max_backups)
{
