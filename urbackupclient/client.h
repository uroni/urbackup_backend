...
private:
	...
	std::vector<SFileAndHash> convertToFileAndHash(const std::string& orig_dir, const std::string& named_dir, const std::vector<SFile> files, const std::string& fn_filter);
	void handleSymlinks(const std::string& orig_dir, const std::string& named_dir, std::vector<SFileAndHash>& files);
