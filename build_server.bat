...
copy "urbackupserver\Release Server PreVista\*" "Release Server PreVista\"
...
copy "urbackupserver\x64\Release Server PreVista\*" "x64\Release Server PreVista\"
