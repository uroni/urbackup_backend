...
msbuild UrBackupBackend.sln /p:Configuration=Release /p:Platform="ARM64"  /p:vcpkgTriplet="arm64-windows-static-md"
if %errorlevel% neq 0 exit /b %errorlevel%
...
msbuild CompiledServer.vcxproj /p:Configuration="Release Service" /p:Platform="arm64"  /p:vcpkgTriplet="arm64-windows-static-md"
if %errorlevel% neq 0 exit /b %errorlevel%
